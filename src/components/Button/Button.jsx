...
const Button = ({
  ...
  const hoverAfterStyles = {
    ...
    borderImage: hover.after.borderImage,
  };
  const ExtraHoverAfterStyles = {
    ...
    borderImage: hover.extraAfter?.borderImage,
  };
  const afterStyles = {
    width: after.width,
    height: after.height,
  ...
  const ExtraAfterStyles = {
    ...
    borderImage: extraAfter.borderImage,
  };
  const hoverBeforeStyles = {
    ...
    borderImage: hover.before.borderImage,
  };
  const ExtraHoverBeforeStyles = {
    ...
    borderImage: hover.extraBefore?.borderImage,
  };
  const beforeStyles = {
    width: before.width,
    ...
    borderImage: before.borderImage,
  };
  const ExtraBeforeStyles = {
    ...
    borderImage: extraBefore.borderImage,
  };
  const styles = {
    width,
    height,
  ...
  return (
    <>
      ...
      >
        ...
        {<span style={Hover ? hoverAfterStyles : afterStyles}></span>}
